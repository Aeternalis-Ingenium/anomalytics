...
@pytest.fixture(name="get_sample_2_df", scope="function")
def get_sample_2_df(request):
    request.cls.sample_2_df = pd.DataFrame(
        data={
            "feature_1": [
                263,
                275,
...
@pytest.fixture(name="get_sample_4_df", scope="function")
def get_sample_4_df(request):
    request.cls.sample_4_df = pd.DataFrame(
        data={
            "feature_1": [
                263,
                275,
